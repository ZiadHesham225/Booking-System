...
namespace Booking_System.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_EventTicketTypes_EventTicketTypeId",
            ...
            migrationBuilder.InsertData(
                table: "TicketTypes",
                columns: new[] { "TicketTypeId", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, true, "Standard" },
                    { 2, true, "VIP" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventTicketTypes_EventId_TicketTypeId",
                table: "EventTicketTypes",
                columns: new[] { "EventId", "TicketTypeId" },
                unique: true);
